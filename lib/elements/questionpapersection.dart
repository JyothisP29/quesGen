...
class QuestionPaperSection extends StatefulWidget {
  ...
  const QuestionPaperSection({Key? key,  required this.controller, required this.paper}) : super(key: key);
  final QuestionPaper paper;
  @override
  State<QuestionPaperSection> createState() => _QuestionPaperSectionState();
}

class _QuestionPaperSectionState extends State<QuestionPaperSection> with SingleTickerProviderStateMixin {
